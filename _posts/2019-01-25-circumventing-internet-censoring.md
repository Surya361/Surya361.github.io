...
A while back one of my friend recommended the [tv series, 24](https://en.wikipedia.org/wiki/24_(TV_series)), but i couldn't find it on any of the streaming services, when enquired she reverted back with a link to 123moviestime.com, which for some reason was blocked in India. I started digging into the implementation of the block.
